...
export interface IOnDemandGetCompetitorsOptions {
    ...
    fields?: string | string[];
    maxRecords?: number;
    excludePriceAndVolumeFilter?: never /* possible values [boolean, 1|0 , '1'|'0', 'true'|'false'] 
 please check docs of specific method for given property. 
 please fix in barchart-ondemand-client-js as well! */;
}
...
export interface IOnDemandGetLeadersOptions {
    ...
    sortDirection?: ("ASC" | "DESC");
    excludeEtfsFromStocks?: never /* possible values [boolean, 1|0 , '1'|'0', 'true'|'false'] 
 please check docs of specific method for given property. 
 please fix in barchart-ondemand-client-js as well! */;
}
...
export interface IOnDemandGetEquityOptionsExpirationsResponse extends IOnDemandResponse {
    results: {
        ...
        optionTypes?: { monthly: string[]; weekly: string[]; };
    }[] | null;
};