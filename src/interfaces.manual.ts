// Interfaces we're missing the definitions for in the API documentation
...
export interface IOnDemandGetHistoricHighsLowsResponse
  extends IOnDemandResponse {
  results: {
    name: string;
    symbol: string;
...
export interface IOnDemandGetFuturesOptionsHistoryResponse
  extends IOnDemandResponse {
  results: {
    symbol: string;
    root: string;
