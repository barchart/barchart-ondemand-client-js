...
export declare class OnDemandClient {
    ...
    getTechnicals(options: IOnDemandGetTechnicalsOptions): Promise<IOnDemandGetTechnicalsResponse>;
    ...
    getFuturesOptionsHistory(options: IOnDemandGetFuturesOptionsHistoryOptions): Promise<IOnDemandGetFuturesOptionsHistoryResponse>;
    ...
    getDividendData(options: IOnDemandGetDividendDataOptions): Promise<IOnDemandGetDividendDataResponse>;
    getEquityOptionsExpirations(options: IOnDemandGetEquityOptionsExpirationsOptions): Promise<IOnDemandGetEquityOptionsExpirationsResponse>;
